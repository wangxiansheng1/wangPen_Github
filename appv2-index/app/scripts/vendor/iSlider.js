...
(function(global) {
    ...
    iSliderPrototype._renderWrapper = function() {
        ...
        if (!this.outer) {
            ...
            this.pageouter = document.createElement('span');
            this.pageouter.className = 'swiper-pagination';
            this.wrap.appendChild(this.pageouter);
            ...
            for (var i = 0; i < this._opts.data.length; i++) {
                ...
                this.pageouter.appendChild(page);
            }
        }
    ...
    iSliderPrototype.slideTo = function(dataIndex, opts) {
        ...
        for (var i = 0; i < datalength; i++) {
            removeClass(this.pageouter.children[i], "swiper-pagination-bullet-active");

            if (i == (dataIndex + datalength) % datalength) {
                addClass(this.pageouter.children[i], 'swiper-pagination-bullet-active')
            }
        }
