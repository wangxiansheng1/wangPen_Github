...
window.onload=function(){
	...
	function bindEvents() {
		...
		/*阅读并同意协议*/
		$('.reg_protocol').on('click', function() {
			$(this).toggleClass('reg_protocol_selected');
			if ($(this).hasClass('reg_protocol_selected')) {
				_len_protocol=1;
			} else {
				_len_protocol=0;
			}
	...
	function enableRegister() {
		if (_len_phone && _len_passwd && _len_sms && _len_protocol ) {
